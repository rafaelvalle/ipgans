...
def main(num_epochs=100, epochsize=100, batchsize=64, initial_eta=1e-4,
    ...
    if optimizer == 'adam':
        generator_updates = lasagne.updates.adam(
                -generator_score, generator_params, learning_rate=eta, beta1=0.5)
        critic_updates = lasagne.updates.adam(
                -critic_score, critic_params, learning_rate=eta, beta1=0.5)
    ...
    for epoch in range(num_epochs):
        ...
        plt.savefig("histograms/mnist_wgan_histogram_epoch_{}".format(epoch))
