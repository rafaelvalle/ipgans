...
def main(num_epochs=100, epochsize=100, batchsize=64, initial_eta=1e-4,
    ...
    alpha = srng.uniform((batchsize, 1, 1, 1), low=0., high=1.)
    ...
    if optimizer == 'adam':
        generator_updates = lasagne.updates.adam(
                -generator_score, generator_params, learning_rate=eta, beta1=0.5, beta2=0.9)
        critic_updates = lasagne.updates.adam(
                -critic_score, critic_params, learning_rate=eta, beta1=0.5, beta2=0.9)
    ...
    for epoch in range(num_epochs):
        ...
        try:
            ...
            plt.imsave('iwgan_mnist_samples.png',
        ...
        plt.savefig("histograms/mnist_iwgan_histogram_epoch_{}".format(epoch))
    ...
    np.savez('iwgan_mnist_gen.npz', *lasagne.layers.get_all_param_values(generator))
    np.savez('iwgan_mnist_crit.npz', *lasagne.layers.get_all_param_values(critic))
    #
